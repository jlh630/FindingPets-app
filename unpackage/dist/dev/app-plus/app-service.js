...
(function(vue) {
    ...
    (function(f) {
      ...
      return (/* @__PURE__ */ function() {
        ...
        function connect(packet, stream, opts) {
          ...
          var clientId2 = settings.clientId || "";
          ...
          if (protocolVersion !== 3 && protocolVersion !== 4 && protocolVersion !== 5) {
            ...
            length += 1;
          if ((typeof clientId2 === "string" || Buffer.isBuffer(clientId2)) && (clientId2 || protocolVersion === 4) && (clientId2 || clean)) {
            length += clientId2.length + 2;
          } else {
  ...
  const _sfc_main$1 = {
    ...
    setup(__props) {
      ...
      const src = vue.ref("/static/none.jpg");
      const client = vue.ref(null);
      const timer = vue.ref(null);
      const deviceId = vue.ref("");
      const warn = vue.ref(true);
      const logs = vue.ref([]);
      const showWindows = vue.ref(false);
      let myOptions = {
        clean: true,
        connectTimeout: 4e3,
        reconnectPeriod: 1e3,
      ...
      function log(message) {
        ...
        const formattedTime = `${currentTime.getMonth() + 1}-${currentTime.getDate()} ${currentTime.getHours()}:${currentTime.getMinutes()}:${currentTime.getSeconds()}`;
        logs.value.push({
          formattedTime,
          message
        });
        formatAppLog("log", "at pages/index/index.vue:80", formattedTime + ":" + message);
      }
      function connectMqtt() {
        ...
        if (isConnected.value) {
          ...
          client.value.on("message", (topic2, message) => {
      ...
      function startTracking() {
        if (!timer.value) {
          formatAppLog("log", "at pages/index/index.vue:190", "开始发送位置");
          getLocation();
          timer.value = setInterval(getLocation, 5e3);
        }
      }
      ...
      return (_ctx, _cache) => {
        return vue.openBlock(), vue.createElementBlock("view", { class: "content" }, [
          vue.createElementVNode("view", { class: "page" }, [
            vue.createElementVNode("view", { class: "image-content" }, [
              vue.createElementVNode("image", {
                style: { "width": "400px", "height": "200px", "background-color": "#eeeeee" },
                mode: "scaleToFill",
                src: src.value
              }, null, 8, ["src"])
            ])
          ]),
          vue.createElementVNode("view", { class: "uni-form-item uni-column text-area" }, [
            vue.withDirectives(vue.createElementVNode(
              "input",
              {
                class: "uni-input",
                "confirm-type": "go",
                "onUpdate:modelValue": _cache[0] || (_cache[0] = ($event) => deviceId.value = $event),
              ...
              [vue.vModelText, deviceId.value]
            ]),
            vue.createElementVNode("button", {
              type: isConnected.value ? "warn" : "primary",
              size: "mini",
              onClick: connectMqtt
            }, vue.toDisplayString(isConnected.value ? "断开连接" : "建立连接"), 9, ["type"])
          ]),
          isConnected.value ? (vue.openBlock(), vue.createElementBlock("view", {
            key: 0,
            class: "coordinates"
          }, [
            vue.createElementVNode("p", { class: "label" }, [
              vue.createTextVNode("纬度: "),
              vue.createElementVNode(
                "span",
                { class: "value" },
                vue.toDisplayString(location.value.latitude),
                1
                /* TEXT */
              )
            ]),
            vue.createElementVNode("p", { class: "label" }, [
              vue.createTextVNode("经度: "),
              vue.createElementVNode(
                "span",
                { class: "value" },
                vue.toDisplayString(location.value.longitude),
                1
                /* TEXT */
              )
            ])
          ...
          vue.createCommentVNode(" 日志框 "),
          isConnected.value ? (vue.openBlock(), vue.createElementBlock("view", {
            key: 2,
            class: "log-container"
          }, [
            vue.createElementVNode("view", { class: "log-header" }, "logs"),
            vue.createElementVNode("view", { class: "log-content" }, [
              (vue.openBlock(true), vue.createElementBlock(
                vue.Fragment,
                null,
                vue.renderList(logs.value, (log2, index) => {
                  return vue.openBlock(), vue.createElementBlock("view", { key: index }, [
                    vue.createElementVNode(
                      "span",
                      { style: { "color": "seagreen" } },
                      vue.toDisplayString(log2.formattedTime),
                      1
                      /* TEXT */
                    ),
                    vue.createElementVNode(
                      "span",
                      null,
                      vue.toDisplayString(":" + log2.message),
                      1
                      /* TEXT */
                    )
                  ]);
  ...
  const PagesIndexIndex = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__file", "D:/uniapp_space/gps_test/pages/index/index.vue"]]);
  ...
  const App = /* @__PURE__ */ _export_sfc(_sfc_main, [["__file", "D:/uniapp_space/gps_test/App.vue"]]);
  uni.connectSocket = /* @__PURE__ */ function(connectSocket) {
    return function(options) {
      formatAppLog("log", "at main.js:18", options);
